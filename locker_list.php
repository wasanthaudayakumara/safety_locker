...
<table class="table">
  <h1 class="h4 text-center">Locker List</h1>
  <thead>
    <tr>
      <th scope="col">#</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><p href="../add_locker.php?lid=<?php echo $row["lid"]; ?>"><?php echo $row["status"]; ?></p>
      </td>
...
<div class="text-center">
 <a href="locker_list_print.php" class="btn btn-primary">Print</a>
