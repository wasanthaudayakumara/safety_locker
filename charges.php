...
<?php $page_title="safety_locker|Charges"; ?>
...
<div class="container pb-5 pt-1  bg-white my-5 ">
	...
	<h1 class="h4 text-center">Add New Charges</h1>
  <form action="sql/charges_sql.php" method="POST" enctype="multipart/form-data">
...
<div class="form-floating mb-3">
    <input type="text" class="form-control"  placeholder="a" name="amount" required="">
